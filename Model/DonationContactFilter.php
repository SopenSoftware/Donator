...
class Donator_Model_DonationContactFilter extends Tinebase_Model_Filter_ForeignId
{
    /**
    ...
    public function appendFilterSql($_select, $_backend)
    {
        ...
        $_select->where('fundmaster_id' . ' IN (?)', empty($this->_foreignIds) ? array('') : $this->_foreignIds);
    }
